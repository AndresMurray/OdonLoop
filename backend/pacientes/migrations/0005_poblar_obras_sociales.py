# Generated migration for populating obras sociales

from django.db import migrations


def poblar_obras_sociales(apps, schema_editor):
    """Poblar la base de datos con obras sociales argentinas"""
    ObraSocial = apps.get_model('pacientes', 'ObraSocial')
    ...
    # Crear obras sociales solo si no existen
...
def despoblar_obras_sociales(apps, schema_editor):
    """Eliminar obras sociales (para reversión de migración)"""
    ObraSocial = apps.get_model('pacientes', 'ObraSocial')
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('pacientes', '0004_obrasocial_remove_paciente_alergias_and_more'),
    ]

    operations = [
        migrations.RunPython(poblar_obras_sociales, despoblar_obras_sociales),
    ]
