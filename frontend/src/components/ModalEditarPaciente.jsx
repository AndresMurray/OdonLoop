  ...
  useEffect(() => {
    if (isOpen && paciente) {
      ...
      setForm({
        ...
        obra_social: paciente.obra_social_otra ? 'otra' : (paciente.obra_social_detalle?.id || ''),
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const payload = {
        ...
        obra_social: form.obra_social === 'otra' ? null : (form.obra_social || null),
        obra_social_otra: form.obra_social === 'otra' ? form.obra_social_otra.trim() : '',
